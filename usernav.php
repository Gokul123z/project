            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="cust_reg.php" class="dropdown-item">Edit Profile</a>
                          <a href="cust_reg.php" class="dropdown-item">Password Change</a>
                        
                       
                    </div>
                </div>
                <a href="index.php" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Logout<i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </nav>